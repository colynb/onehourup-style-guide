  ...
  computed: {
    ...
    classes() {
      ...
      const primaryClasses = {
        ...
        'hover:bg-primary-alt hover:border-transparent': this.isPrimary && this.isOutlined,
      ...
      const dangerClasses = {
        ...
        'hover:bg-danger-alt hover:border-transparent': this.isDanger && this.isOutlined,
