<template>
  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <nuxt-link to="/"
        ><Logo class="w-48 mx-auto mb-12 text-primary"
      /></nuxt-link>
      <Display class="text-center" size="4">
        ...
        <form action="#" method="POST">
          ...
          <div class="mt-6 flex items-center justify-between">
            ...
            <div class="text-sm leading-5">
              <a
                href="#"
                class="font-medium text-primary hover:text-primary-dark focus:outline-none focus:underline transition ease-in-out duration-150"
              >
