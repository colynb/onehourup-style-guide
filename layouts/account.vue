<template>
  <div>
    <div class="bg-white text-gray-800">
      <navbar />
      <div class="py-24 mb-12">
        <div class="container mx-auto">
          <Display size="3">Account Settings</Display>
          <Display
    ...
    <div class="max-w-7xl mx-auto">
      <div class="flex w-full">
        <nav class="w-56">
          <a
            href="#"
            class="group flex items-center px-3 py-2 text-sm leading-5 font-medium text-gray-900 rounded-md bg-gray-200 hover:text-gray-900 focus:outline-none focus:bg-gray-300 transition ease-in-out duration-150"
          >
            <svg
          ...
          >
            <svg
              class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 text-gray-400 group-focus:text-gray-500 transition ease-in-out duration-150"
              stroke="currentColor"
              fill="none"
              viewBox="0 0 24 24"
            >
